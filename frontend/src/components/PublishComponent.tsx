...
export const PublishComponent = ({onTextAreaChange}: {onTextAreaChange: (e: ChangeEvent<HTMLTextAreaElement>) => void}) => {
...
<div className="w-2/3">
   <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50">
       ...
       <div className="px-4 py-2 bg-white rounded-b-lg">
           ...
           <textarea onChange={onTextAreaChange} id="editor" rows={8} className="block w-full px-0 text-md text-gray-800 bg-white border-0 focus:outline-none focus:ring-O" placeholder="Write an article..." required ></textarea>
       </div>
   </div>
</div>
